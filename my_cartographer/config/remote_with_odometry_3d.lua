...
options = {
  ...
  published_frame = "odom",  -- required for odometry
  odom_frame = "odom",
  provide_odom_frame = false,  -- required for odometry
  publish_frame_projected_to_2d = false,
  --use_pose_extrapolator=true, --追記(不要)
  use_odometry = true,  -- required for odometry
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 2,
