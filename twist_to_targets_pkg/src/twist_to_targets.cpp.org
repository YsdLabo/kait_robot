		...
		//ROS_INFO("Idling");
			if(change_direction) {
				...
				// 左前・右後(5,6)
					...
					msg.data="l";
					stop=msg;
					ROS_INFO("L-Front,R-Lear");
					steering_pub.publish(msg);
                
					steering_d[MOTOR2] = -M_PI_4;
					steering_d[MOTOR4] = M_PI_4;
					steering_d[MOTOR6] = M_PI_4;
					steering_d[MOTOR8] = -M_PI_4;
				}
				// 右前・左後(7,8)
				...
				// 旋回(9,10)
					...
					steering_d[MOTOR2] = M_PI_4; // d
					steering_d[MOTOR4] = M_PI_4; // a
					steering_d[MOTOR6] = -M_PI_4; // d
					steering_d[MOTOR8] = -M_PI_4;  // a
            	}
